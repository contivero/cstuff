...
programming (although many are applicable to any language).
...
* [Concatenating string constants](#concatenating-string-constants)
...
Adjacent string constants are concatenated at compile time, for instance:
